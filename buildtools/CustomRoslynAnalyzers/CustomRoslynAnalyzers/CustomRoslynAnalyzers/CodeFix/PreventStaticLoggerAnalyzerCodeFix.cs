...
namespace CustomRoslynAnalyzers.CodeFix
{
    ...
    public class PreventStaticLoggerAnalyzerCodeFix : CodeFixProvider
    {
        private const string title = "Suppress Message of Logger/ILogger.";

        public sealed override ImmutableArray<string> FixableDiagnosticIds
        {
            get { return ImmutableArray.Create(DiagnosticIds.PreventStaticLoggersRuleId); }
        }
        ...
        public async sealed override Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            if (fieldDeclaration != null)
            {
                ...
                CodeAction.Create(
                    title: title,
                    createChangedSolution: c => codeFixHelper.CodeFixHelperInFieldAsync(context.Document, fieldDeclaration, c, DiagnosticIds.PreventStaticLoggersRuleId),
            ...
            if (propertyDeclaration != null)
            {
                ...
                CodeAction.Create(
                    title: title,
                    createChangedSolution: c => codeFixHelper.CodeFixHelperInPropertyAsync(context.Document, propertyDeclaration, c, DiagnosticIds.PreventStaticLoggersRuleId),
                    equivalenceKey: title),
                    diagnostic);
            }
            ...
            if (methodDeclaration != null)
            {
                ...
                CodeAction.Create(
                    title: title,
                    createChangedSolution: c => codeFixHelper.CodeFixHelperInMethodAsync(context.Document, methodDeclaration, c, DiagnosticIds.PreventStaticLoggersRuleId),
                    equivalenceKey: title),
                    diagnostic);
            }
        }
